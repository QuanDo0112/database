   ...
   */
   public void testReadWriteDeadlock() throws Exception {
    ...
    while (true) {
      ...
      TestUtil.assertFalse(lg1Write.acquired() && lg2Write.acquired());
   ...
   */
   public void testWriteWriteDeadlock() throws Exception {
    ...
    while (true) {
      ...
      TestUtil.assertFalse(lg1Write1.acquired() && lg2Write0.acquired());
   ...
   */
   public void testUpgradeWriteDeadlock() throws Exception {
    ...
    while (true) {
      ...
      System.out.println("Log 1 acquired: : " + lg1Write.acquired());
      System.out.println("Log 2 acquired: " + lg2Write.acquired());
      TestUtil.assertFalse(lg1Write.acquired() && lg2Write.acquired());
      if (lg1Write.acquired() && !lg2Write.acquired()) break;
      if (!lg1Write.acquired() && lg2Write.acquired()) break;
