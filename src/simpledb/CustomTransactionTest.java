...
public class CustomTransactionTest extends SimpleDbTestBase {
    ...
    private void validateTransactions(int threads)
        ...
        it.open();
        Tuple tup = it.next();
        System.out.println("Number of insertions: " + ((IntField) tup.getField(0)).getValue());
        TestUtil.assertEquals(threads, ((IntField) tup.getField(0)).getValue());
        it.close();
    ...
    private static class XactionTester extends Thread {
        ...
        public void run() {
            try {
                ...
                //System.out.println("thread " + tr + " done");
            } catch (Exception e) {
    ...
    private void fail(String message) {
    	System.err.println("Transaction test failed with message: " + message);
    	System.exit(1);
    }
}
